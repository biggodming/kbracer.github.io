let carouselList = [
  { serial: '献祭星球の召唤', title: '“地鸣”巨人', desc: '#星球传送带艺术#' },
  { serial: '汝可识锝此阵', title: '宇宙八卦阵', desc: '#戴森球艺术#' },
  { serial: '用科技编制传统', title: '中国结', desc: '#传送带艺术#' },
  { serial: '爷的童年回来了', title: '哆啦A梦', desc: '#星球雕塑#' },
  { serial: '向宇宙传播希望', title: 'badapple!', desc: '#行为艺术#' },
